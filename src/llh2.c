...
int llh2__internal__c_load__sub_length (
  llh2__internal_t* state,
  const unsigned char* p,
    const unsigned char* endp) {
  return state->_sub_length;
}
...
static llparse_state_t llh2__internal__run(
  ...
  switch ((llparse_state_t) (intptr_t) state->_current) {
    ...
    s_n_llh2__internal__n_altsvc_origin_length_uint_16be_byte2 : {
      ...
      state->altsvc_origin_length = (state->altsvc_origin_length << 8) | (*p);
      p++;
    ...
    s_n_llh2__internal__n_altsvc_origin_length_uint_16be : {
      ...
      state->altsvc_origin_length = (*p);
      p++;
      goto s_n_llh2__internal__n_altsvc_origin_length_uint_16be_byte2;
      UNREACHABLE;
    }
    ...
    s_n_llh2__internal__n_last_stream_id_uint_32be_byte4 : {
      ...
      state->last_stream_id = (state->last_stream_id << 8) | (*p);
      p++;
    ...
    s_n_llh2__internal__n_last_stream_id_uint_32be_byte3 : {
      ...
      state->last_stream_id = (state->last_stream_id << 8) | (*p);
      p++;
      goto s_n_llh2__internal__n_last_stream_id_uint_32be_byte4;
      UNREACHABLE;
    }
    ...
    s_n_llh2__internal__n_last_stream_id_uint_32be_byte2 : {
      ...
      state->last_stream_id = (state->last_stream_id << 8) | (*p);
      p++;
      goto s_n_llh2__internal__n_last_stream_id_uint_32be_byte3;
      UNREACHABLE;
    }
    ...
    s_n_llh2__internal__n_last_stream_id_uint_32be : {
      ...
      state->last_stream_id = (*p);
      p++;
      goto s_n_llh2__internal__n_last_stream_id_uint_32be_byte2;
      UNREACHABLE;
    }
    ...
    s_n_llh2__internal__n_promise_stream_id_uint_32be_byte3 : {
      ...
      state->promise_stream_id = (state->promise_stream_id << 8) | (*p);
      p++;
      goto s_n_llh2__internal__n_promise_stream_id_uint_32be_byte4;
      UNREACHABLE;
    }
    ...
    s_n_llh2__internal__n_promise_stream_id_uint_32be_byte2 : {
      ...
      state->promise_stream_id = (state->promise_stream_id << 8) | (*p);
      p++;
      goto s_n_llh2__internal__n_promise_stream_id_uint_32be_byte3;
      UNREACHABLE;
    }
    ...
    s_n_llh2__internal__n_promise_stream_id_uint_32be : {
      ...
      p++;
      goto s_n_llh2__internal__n_promise_stream_id_uint_32be_byte2;
      UNREACHABLE;
    }
    ...
    s_n_llh2__internal__n_error_code_uint_32be_byte4_1 : {
      ...
      state->error_code = (state->error_code << 8) | (*p);
      p++;
      goto s_n_llh2__internal__n_invoke_llh2__internal__on_error_code_complete_1;
      UNREACHABLE;
    }
    ...
    s_n_llh2__internal__n_error_code_uint_32be_byte3_1 : {
      ...
      state->error_code = (state->error_code << 8) | (*p);
      p++;
      goto s_n_llh2__internal__n_error_code_uint_32be_byte4_1;
      UNREACHABLE;
    }
    ...
    s_n_llh2__internal__n_error_code_uint_32be_byte2_1 : {
      ...
      state->error_code = (state->error_code << 8) | (*p);
      p++;
      goto s_n_llh2__internal__n_error_code_uint_32be_byte3_1;
      UNREACHABLE;
    }
    ...
    s_n_llh2__internal__n_error_code_uint_32be_1 : {
      ...
      state->error_code = (*p);
      p++;
      goto s_n_llh2__internal__n_error_code_uint_32be_byte2_1;
      UNREACHABLE;
    }
    ...
    s_n_llh2__internal__n_consume__sub_length_3 : {
      ...
      if (avail >= need) {
        p += need;
        state->_sub_length = 0;
        goto s_n_llh2__internal__n_span_end_llh2__internal__on_body_5;
      }
      
      state->_sub_length -= avail;
      return s_n_llh2__internal__n_consume__sub_length_3;
      UNREACHABLE;
    }
    ...
    s_n_llh2__internal__n_span_start_llh2__internal__on_body_5 : {
      ...
      state->_span_pos0 = (void*) p;
      state->_span_cb0 = llh2__internal__on_body;
      goto s_n_llh2__internal__n_consume__sub_length_3;
      UNREACHABLE;
    }
    ...
    s_n_llh2__internal__n_invoke_llh2__before_headers_frame_body : {
      switch (llh2__before_headers_frame_body(state, p, endp)) {
        case 1:
          goto s_n_llh2__internal__n_invoke_llh2__internal__on_frame_end;
        case 0:
          goto s_n_llh2__internal__n_span_start_llh2__internal__on_body_5;
        default:
    ...
    s_n_llh2__internal__n_invoke_llh2__internal__on_body_complete_6 : {
      switch (llh2__internal__on_body_complete(state, p, endp)) {
        ...
        default:
          goto s_n_llh2__internal__n_error_40;
      }
      UNREACHABLE;
    }
    ...
    s_n_llh2__internal__n_consume__sub_length_4 : {
      ...
      if (avail >= need) {
        p += need;
        state->_sub_length = 0;
        goto s_n_llh2__internal__n_span_end_llh2__internal__on_body_6;
      }
      
      state->_sub_length -= avail;
      return s_n_llh2__internal__n_consume__sub_length_4;
      UNREACHABLE;
    }
    ...
    s_n_llh2__internal__n_span_start_llh2__internal__on_body_6 : {
      ...
      state->_span_pos0 = (void*) p;
      state->_span_cb0 = llh2__internal__on_body;
      goto s_n_llh2__internal__n_consume__sub_length_4;
      UNREACHABLE;
    }
    ...
    s_n_llh2__internal__n_invoke_load_type : {
      switch (llh2__internal__c_load_type(state, p, endp)) {
        ...
        case 7:
          goto s_n_llh2__internal__n_last_stream_id_uint_32be;
        case 6:
    ...
    s_n_llh2__internal__n_stream_id_uint_32be_byte3 : {
      ...
      state->stream_id = (state->stream_id << 8) | (*p);
      p++;
      goto s_n_llh2__internal__n_stream_id_uint_32be_byte4;
      UNREACHABLE;
    }
    ...
    s_n_llh2__internal__n_stream_id_uint_32be_byte2 : {
      ...
      state->stream_id = (state->stream_id << 8) | (*p);
      p++;
      goto s_n_llh2__internal__n_stream_id_uint_32be_byte3;
      UNREACHABLE;
    }
    ...
    s_n_llh2__internal__n_stream_id_uint_32be : {
      ...
      state->stream_id = (*p);
      p++;
      goto s_n_llh2__internal__n_stream_id_uint_32be_byte2;
      UNREACHABLE;
    }
  ...
  s_n_llh2__internal__n_pause_3: {
    ...
    state->error_pos = (const char*) p;
    state->_current = (void*) (intptr_t) s_n_llh2__internal__n_stream_id_uint_32be;
    return s_error;
    UNREACHABLE;
  }
  s_n_llh2__internal__n_pause_4: {
  ...
  s_n_llh2__internal__n_pause_8: {
    ...
    state->error_pos = (const char*) p;
    state->_current = (void*) (intptr_t) s_n_llh2__internal__n_invoke_llh2__before_field_start;
    return s_error;
    UNREACHABLE;
  }
  s_n_llh2__internal__n_pause_9: {
  ...
  s_n_llh2__internal__n_invoke_llh2__internal__on_altsvc_origin_length_complete: {
    switch (llh2__internal__on_altsvc_origin_length_complete(state, p, endp)) {
      ...
      case 0:
        goto s_n_llh2__internal__n_invoke_llh2__before_field_start;
      default:
  ...
  s_n_llh2__internal__n_pause_13: {
    ...
    state->error_pos = (const char*) p;
    state->_current = (void*) (intptr_t) s_n_llh2__internal__n_invoke_llh2__check_goaway_frame_length;
    return s_error;
    UNREACHABLE;
  }
  s_n_llh2__internal__n_error_18: {
  ...
  s_n_llh2__internal__n_pause_14: {
    ...
    state->error_pos = (const char*) p;
    state->_current = (void*) (intptr_t) s_n_llh2__internal__n_invoke_load__sub_length;
    return s_error;
    UNREACHABLE;
  }
  s_n_llh2__internal__n_pause_15: {
  ...
  s_n_llh2__internal__n_invoke_llh2__internal__on_error_code_complete: {
    switch (llh2__internal__on_error_code_complete(state, p, endp)) {
      ...
      case 0:
        goto s_n_llh2__internal__n_invoke_load__sub_length;
      default:
  ...
  s_n_llh2__internal__n_pause_18: {
    ...
    state->error_pos = (const char*) p;
    state->_current = (void*) (intptr_t) s_n_llh2__internal__n_invoke_llh2__before_push_promise_frame_body_start;
    return s_error;
    UNREACHABLE;
  }
  s_n_llh2__internal__n_pause_19: {
  ...
  s_n_llh2__internal__n_invoke_llh2__internal__on_promise_stream_id_complete: {
    switch (llh2__internal__on_promise_stream_id_complete(state, p, endp)) {
      ...
      case 0:
        goto s_n_llh2__internal__n_invoke_llh2__before_push_promise_frame_body_start;
      default:
  ...
  s_n_llh2__internal__n_pause_17: {
    ...
    state->error_pos = (const char*) p;
    state->_current = (void*) (intptr_t) s_n_llh2__internal__n_promise_stream_id_uint_32be;
    return s_error;
    UNREACHABLE;
  }
  s_n_llh2__internal__n_error_21: {
  ...
  s_n_llh2__internal__n_invoke_is_equal_length_2: {
    switch (llh2__internal__c_is_equal_length(state, p, endp)) {
      ...
      default:
        goto s_n_llh2__internal__n_error_code_uint_32be_1;
    }
    UNREACHABLE;
  }
  s_n_llh2__internal__n_error_33: {
  ...
  s_n_llh2__internal__n_span_end_llh2__internal__on_body_5: {
    ...
    if (err != 0) {
      state->error = err;
      state->error_pos = (const char*) p;
      state->_current = (void*) (intptr_t) s_n_llh2__internal__n_invoke_llh2__internal__on_body_complete_5;
      return s_error;
    }
    goto s_n_llh2__internal__n_invoke_llh2__internal__on_body_complete_5;
    UNREACHABLE;
  }
  s_n_llh2__internal__n_error_36: {
    state->error = 0x18;
  ...
  s_n_llh2__internal__n_pause_26: {
    ...
    state->reason = "on_stream_weight_complete pause";
    state->error_pos = (const char*) p;
    state->_current = (void*) (intptr_t) s_n_llh2__internal__n_invoke_llh2__before_headers_frame_body;
    return s_error;
    UNREACHABLE;
  }
  s_n_llh2__internal__n_error_35: {
  ...
  s_n_llh2__internal__n_pause_29: {
    ...
    state->reason = "on_body_complete pause";
    state->error_pos = (const char*) p;
    state->_current = (void*) (intptr_t) s_n_llh2__internal__n_invoke_test_flags_6;
    return s_error;
    UNREACHABLE;
  }
  s_n_llh2__internal__n_error_40: {
  ...
  s_n_llh2__internal__n_span_end_llh2__internal__on_body_6: {
    ...
    if (err != 0) {
      state->error = err;
      state->error_pos = (const char*) p;
      state->_current = (void*) (intptr_t) s_n_llh2__internal__n_invoke_llh2__internal__on_body_complete_6;
      return s_error;
    }
    goto s_n_llh2__internal__n_invoke_llh2__internal__on_body_complete_6;
    UNREACHABLE;
  }
  s_n_llh2__internal__n_error_41: {
    state->error = 0x18;
  ...
  s_n_llh2__internal__n_invoke_llh2__internal__on_flags_complete: {
    switch (llh2__internal__on_flags_complete(state, p, endp)) {
      ...
      case 0:
        goto s_n_llh2__internal__n_stream_id_uint_32be;
      default:
